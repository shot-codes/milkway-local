...
<T.Group {position} rotation.y={Math.atan2(position[0], position[2])}>
  ...
  <T.Mesh let:ref {material} scale={$scale} position.x={2}>
    ...
    />
    <T.SphereGeometry args={[3, 256, 256]} />
  </T.Mesh>
</T.Group>
