...
<div class="bg-[#0b0a0c]/80 absolute w-[600px] rounded-3xl p-12 space-y-12">
  ...
  <div>
    <a href={link} rel="noreferrer" target="_blank" class="flex items-center space-x-4 pointer-events-auto">
